@extends('ManagerLayouts.AgentPage')
                                    ...
                                    <form action="/showCustomer/{{ $customer->ApplicationNo }}" method="POST">
                                        ...
                                        <div class="mainDiv">
                                            ...
                                            <button class="btn btn-success statusBtn"
                                                data-application-no="{{ $customer->ApplicationNo }}">Update Status</button>
                        ...
                        success: function(data) {
                            ...
                            if (customers.data.length > 0) {
                                for (let i = 0; i < customers.data.length; i++) {
                                    ...
                                    html +=
                                        '<input type="radio" name="eventStatus" class="form-check-input" id="option1" checked value="pending">';
                                    html += '<label for="option1">Pending</label>';
                                    html +=
                                        '<input type="radio" name="eventStatus" class="form-check-input" id="option2" value="complete" ' +
                                        (customers.data[i]['EventStatus'] === 'complete' ?
                                            'checked' : '') + '>';
                                    html += '<label for="option2">Complete</label>';
                                    html +=
                                        '<input type="radio" name="eventStatus" class="form-check-input" id="option3" value="cancelled" ' +
                                        (customers.data[i]['EventStatus'] === 'cancelled' ?
                                            'checked' : '') + '>';
                                    html += '<label for="option3">Cancelled</label>';
                                    html += '</div>';
                                    html +=
