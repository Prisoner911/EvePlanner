...
@section('company-main')
    ...
    <body>
        ...
        <div id="toastMessage" class="toastMessage">Agent details updated</div>

        <div class="mainContainer" style="margin-top: 2rem;">
            <div class="containerDiv">
                <h2 style="text-align: center;">Edit agent details.</h2>
                <form action="{{ route('agent.update', ['id' => $agent->AgentID]) }}" method="POST">
                    @csrf
                    <div class="content">
                        <div class="mb-3">
                            <label for="agentID">Agent ID</label>
                            <input type="text" class="form-control" name="agentID" id="agentID" placeholder="Name"
                                value="{{ $agent->AgentID }}" readonly />
                        </div>
                        <div class="mb-3">
                            <label for="agentName">Name</label>
                            <input type="text" class="form-control" name="agentName" id="agentName" placeholder="Name"
                                value="{{ $agent->Name }}{{ old('agentName') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control inputOTP" name="agentPhone" id="agentPhone"
                                ...
                                value="{{ $agentPhone }}{{ old('agentPhone') }}" />
                            <span class="text-danger">
                                @error('agentPhone')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control inputOTP" name="agentEmail" id="agentEmail"
                                placeholder="Enter email" value="{{ $agent->Email }}{{ old('agentEmail') }}" />
                            <span class="text-danger">
                                @error('agentEmail')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control inputOTP" name="agentSpecialty" id="agentSpecialty"
                                placeholder="Enter agent specialty"
                                value="{{ $agent->Specialty }}{{ old('agentSpecialty') }}" />
                            <span class="text-danger">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="agentAddress" id="agentAddress" cols="2" rows="3">{{ $agent->Address }}{{ old('agentAddress') }}</textarea>
                            <span class="text-danger">
                                @error('agentAddress')
                                    {{ $message }}
                                @enderror
